...
{
    [DisplayName("PublicExam")]
    public class PublicExamRoute : Root
    {
        public const string Parent = Module + "/public-exam";
        public const string Master = Module + "/public-exam/public-exam-master";
        public const string Detail = Module + "/public-exam/public-exam-detail";
        public const string Preview = Module + "/public-exam/public-exam-preview";
        private const string Default = Rpc + Module + "/public-exam";
        ...
        public const string GetDetailExam = Default + "/get-detail-public-exam";
        public const string SubmitExam = Default + "/submit-public-exam";
        ...
        public const string FilterListExamLevel = Default + "/filter-list-public-exam-level";
        public const string FilterListExamStatus = Default + "/filter-list-public-exam-status";
        ...
        public const string SingleListExamLevel = Default + "/single-list-public-exam-level";
        public const string SingleListExamStatus = Default + "/single-list-public-exam-status";
