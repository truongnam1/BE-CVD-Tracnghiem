...
{
    public class PublicExam_QuestionDTO : DataDTO
    {
        ...
        public List<PublicExam_QuestionContentDTO> QuestionContents { get; set; }
        public PublicExam_QuestionDTO() {}
        public PublicExam_QuestionDTO(Question Question)
        {
            this.Id = Question.Id;
            ...
            this.QuestionContents = Question?.QuestionContents == null ? null :Question.QuestionContents.Select(x => new PublicExam_QuestionContentDTO(x)).ToList();
    ...
    public class PublicExam_QuestionFilterDTO : FilterDTO
    {
