...
namespace Tracnghiem.Rpc.public_exam
{
    ...
    {
        [Route(PublicExamRoute.CountQuestion), HttpPost]
        public async Task<long> CountQuestion([FromBody] PublicExam_QuestionFilterDTO Exam_QuestionFilterDTO)
        {
        ...
        [Route(PublicExamRoute.ListQuestion), HttpPost]
        public async Task<List<PublicExam_QuestionDTO>> ListQuestion([FromBody] PublicExam_QuestionFilterDTO Exam_QuestionFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
            ...
            List<PublicExam_QuestionDTO> Exam_QuestionDTOs = Questions
