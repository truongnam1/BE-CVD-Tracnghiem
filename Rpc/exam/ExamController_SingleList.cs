...
namespace Tracnghiem.Rpc.exam
{
    ...
    {
        [Route(ExamRoute.SingleListAppUser), HttpPost]
        public async Task<List<Exam_AppUserDTO>> SingleListAppUser([FromBody] Exam_AppUserFilterDTO Exam_AppUserFilterDTO)
        {
        ...
        [Route(ExamRoute.SingleListExamLevel), HttpPost]
        public async Task<List<Exam_ExamLevelDTO>> SingleListExamLevel([FromBody] Exam_ExamLevelFilterDTO Exam_ExamLevelFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ExamRoute.SingleListExamStatus), HttpPost]
        public async Task<List<Exam_ExamStatusDTO>> SingleListExamStatus([FromBody] Exam_ExamStatusFilterDTO Exam_ExamStatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ExamRoute.SingleListGrade), HttpPost]
        public async Task<List<Exam_GradeDTO>> SingleListGrade([FromBody] Exam_GradeFilterDTO Exam_GradeFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ExamRoute.SingleListImage), HttpPost]
        public async Task<List<Exam_ImageDTO>> SingleListImage([FromBody] Exam_ImageFilterDTO Exam_ImageFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ExamRoute.SingleListStatus), HttpPost]
        public async Task<List<Exam_StatusDTO>> SingleListStatus([FromBody] Exam_StatusFilterDTO Exam_StatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ExamRoute.SingleListSubject), HttpPost]
        public async Task<List<Exam_SubjectDTO>> SingleListSubject([FromBody] Exam_SubjectFilterDTO Exam_SubjectFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(ExamRoute.SingleListQuestion), HttpPost]
        public async Task<List<Exam_QuestionDTO>> SingleListQuestion([FromBody] Exam_QuestionFilterDTO Exam_QuestionFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
            ...
            QuestionFilter.StatusId = new IdFilter{ Equal = 1 };
