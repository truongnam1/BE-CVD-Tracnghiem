...
namespace Tracnghiem.Rpc.question
{
    ...
    {
        [Route(QuestionRoute.FilterListGrade), HttpPost]
        public async Task<List<Question_GradeDTO>> FilterListGrade([FromBody] Question_GradeFilterDTO Question_GradeFilterDTO)
        {
        ...
        [Route(QuestionRoute.FilterListQuestionGroup), HttpPost]
        public async Task<List<Question_QuestionGroupDTO>> FilterListQuestionGroup([FromBody] Question_QuestionGroupFilterDTO Question_QuestionGroupFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(QuestionRoute.FilterListQuestionType), HttpPost]
        public async Task<List<Question_QuestionTypeDTO>> FilterListQuestionType([FromBody] Question_QuestionTypeFilterDTO Question_QuestionTypeFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(QuestionRoute.FilterListStatus), HttpPost]
        public async Task<List<Question_StatusDTO>> FilterListStatus([FromBody] Question_StatusFilterDTO Question_StatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(QuestionRoute.FilterListSubject), HttpPost]
        public async Task<List<Question_SubjectDTO>> FilterListSubject([FromBody] Question_SubjectFilterDTO Question_SubjectFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(QuestionRoute.FilterListQuestionContent), HttpPost]
        public async Task<List<Question_QuestionContentDTO>> FilterListQuestionContent([FromBody] Question_QuestionContentFilterDTO Question_QuestionContentFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
